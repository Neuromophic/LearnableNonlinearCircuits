...
learning = int(sys.argv[4])
if learning == 0:
    import pNN_NeuronLevel_LNC_variation_circuit as pNN
elif learning == 1:
    import pNN_LayerLevel_LNC_variation_circuit as pNN
elif learning == 2:
...
for dataset in datasets:
    ...
    for lr_rt in [0.005, 0.]:
        setup = f'dataset:{data_name}_epsilon:{epsilon}_strategy:{strategy}_learning:{learning}_lr_rt:{lr_rt}_seed:{seed}'
        print(setup)
