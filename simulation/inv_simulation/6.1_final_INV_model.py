...
import sys
sys.path.append("/pfs/data5/home/kit/tm/px3192/LearnableNonlinearCircuit/simulation/inv_simulation/")
import torch
...
if os.path.exists(f'./NNs/final_INV_{exp_setup}'):
    ...
    train_data = TensorDataset(Xn_learn, Yn_learn)
    valid_data = TensorDataset(Xn_test, Yn_test)
    ...
    torch.save(model, f'./NNs/final_INV_{exp_setup}')
